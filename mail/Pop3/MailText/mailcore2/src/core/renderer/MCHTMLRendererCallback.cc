...
mailcore::HashMap * HTMLRendererTemplateCallback::templateValuesForHeader(mailcore::MessageHeader * header)
{
    ...
    if (longFormatter == NULL) {
        ...
        longFormatter->setTimeStyle(mailcore::DateFormatStyleMedium);
    }
...
//                 {{#HASSUBJECT}}\
//                 <div>{{EXTRACTEDSUBJECT}}</div>\
//                 {{/HASSUBJECT}}\
//                 {{#NOSUBJECT}}\
//                 <div><i>No Subject</i></div>\
//                 {{/NOSUBJECT}}\
//                 {{#HASFROM}}\
//                 <div><b>发件人:</b> {{FROM}}</div>\
//                 {{/HASFROM}}\
//                 <div><b>时间:</b> {{LONGDATE}}</div>\
//                 {{#HASTO}}\
//                 <div><b>收件人:</b> {{TO}}</div>\
//                 {{/HASTO}}\
//                 {{#HASCC}}\
...
//                 {{/HASBCC}}\
//                 {{#NORECIPIENT}}\
//                 <div><b>收件人:</b> <i>Undisclosed recipient</i></div>\
//                 {{/NORECIPIENT}}\
//                 </div>");
